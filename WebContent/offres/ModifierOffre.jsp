						...
						<c:choose>
							<c:when test="${offre.getType() == 'Vente'}">
								<label class="radio col-md-4"> <input type="radio"
									name="type" value="Vente" id="vente" onclick="Vente()"
									checked="checked"> Vente
								</label>
							</c:when>
							<c:otherwise>
								<label class="radio col-md-4"> <input type="radio"
						...
						<c:choose>
							<c:when test="${offre.getType() == 'Location vacances'}">
								<label class="radio col-md-4"> <input type="radio"
									...
									onClick="Location()" checked="checked"> Location
									vacances
								</label>
							</c:when>
							<c:otherwise>
					...
					<div class="control row col-md-12">
						...
						<c:choose>
							<c:when test="${offre.getCategorie() == 'Maison'}">
								<label class="radio col-md-4" style="display: block;"
									id="Maison"> <input type="radio" name="categorie"
									value="Maison" checked="checked"> Maison
								</label>
							</c:when>
							<c:otherwise>
								<label class="radio col-md-4" style="display: block;"
						...
						<c:choose>
							<c:when
								test="${offre.getCategorie() == 'Villas & maisons de luxe'}">
								<label class="radio col-md-4" style="display: block;"
									id="Villas"> <input type="radio" name="categorie"
									value="Villas & maisons de luxe" checked="checked">
						...
						<c:choose>
							<c:when test="${offre.getCategorie() == 'Riad'}">
								<label class="radio col-md-4" style="display: block;" id="Riad">
									<input type="radio" name="categorie" value="Riad"
									checked="checked"> Riad
								</label>
							</c:when>
							<c:otherwise>
								<label class="radio col-md-4" style="display: block;" id="Riad">
						...
						<c:choose>
							<c:when test="${offre.getCategorie() == 'Chambres'}">
								<label class="radio col-md-4" style="display: none;"
									id="Chambres"> <input type="radio" name="categorie"
									value="Chambres" checked="checked"> Chambres
								</label>
							</c:when>
							<c:otherwise>
								<label class="radio col-md-4" style="display: none;"
									id="Chambres"> <input type="radio" name="categorie"
									value="Chambres"> Chambres
								</label>
							</c:otherwise>
						</c:choose>
						<c:choose>
							<c:when test="${offre.getCategorie() == 'Chambre d un Hôtel'}">
								<label class="radio col-md-4" id="Hotel" style="display: none;">
									<input type="radio" name="categorie" value="Chambre d'un Hotel"
									checked="checked"> Chambre d'un Hôtel
								</label>
							</c:when>
							<c:otherwise>
								<label class="radio col-md-4" id="Hotel" style="display: none;">
						...
						<c:choose>
							<c:when test="${offre.getCategorie() == 'Chambre d une auberge'}">
								<label id="Hauberge" style="display: none;"
									class="radio col-md-4"> <input type="radio"
									name="categorie" value="Chambre d'une auberge"
									checked="checked"> Chambre d'une auberge
								</label>
							</c:when>
							<c:otherwise>
								<label id="Hauberge" style="display: none;"
			...
			<fieldset style="width: 100%; float: left; margin: 0;">
				...
				<div
					...
					<label for="pays">Pays <b style="color: red;">*</b></label> <input
						...
						required="required" type="text" value="${offre.getPays()}"
				...
				<div
					...
					<label for="ville">Ville <b style="color: red;">*</b></label> <input
						...
						value="${offre.getVille()}" data-rule-required="true"
						data-msg-required="Please enter a text"> <span
						class="error1" style="display: none;"> <i
						class="error-log fa fa-exclamation-triangle"></i>
					</span>
			...
			<fieldset style="width: 100%; float: left; margin: 0;">
				...
				<div class="row col-md-12">
					...
					<div class="hs_nombre field hs-form-field  col-md-4"
						...
						<label for="nb_chambre">Nombre de chambres <b
							...
							min="1" max="100" value="${offre.getNb_chambre()}" type="number"
							placeholder="" data-rule-required="true" maxlength="5"
							minlength="0" data-msg-required="Please enter a valid number">
							<span class="error1" style="display: none;"> <i
								class="error-log fa fa-exclamation-triangle"></i>
						</span></label>
					...
					<div class="hs_nombre field hs-form-field  col-md-4"
						...
						<label for="bain">Nombre de salles de bain <b
							...
							size="60" maxlength="128" value="${offre.getSalle_bain()}"
							type="number" placeholder="" data-rule-required="true"
					...
					<div id="inf4" class="col-md-6" style="display: none;">
						<div
							...
							<input id="date_debut" class="form-text hs-input"
								...
								value="${offre.getDate_debut()}" data-rule-required="true"
					...
					<div id="inf5" class="col-md-6" style="display: none;">
						<div
							...
							<input id="date_fin" class="form-text hs-input" name="date_fin"
								value="${offre.getDate_fin()}" required="required" type="date"
								placeholder="" data-rule-required="true"
								data-msg-required="Please enter a valid date"> <span
								class="error1" style="display: none;"> <i
								class="error-log fa fa-exclamation-triangle"></i>
				...
				<div class="row col-md-12">
					<div
						...
						<label for="^prix">Prix/Nuit <b style="color: red;">*</b></label>
						<input id="prix" class="form-text hs-input" name="prix"
							type="number" value="${offre.getPrix()}" placeholder="0"
