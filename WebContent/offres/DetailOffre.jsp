  ...
  <fieldset>
    ...
    <!-- Begin What's Your Email Field -->
        <div class="hs_nombre field hs-form-field">
          ...
          <input id="nmb" name="nombre_personne" required="required" type="number"  value = "${offre.getNombre_personne()}"  data-rule-required="true" data-msg-required="Please enter a number " disabled="disabled">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
