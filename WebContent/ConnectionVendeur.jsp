	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="Accueil.ma" class="nav-link">Acceuil</a></li>
	          ...
	          <li class="nav-item"><a href="ConnexionVendeur.ma" class="nav-link">Connexion</a></li>
        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-8 ftco-animate d-flex align-items-end">
          	<div class="text ">
	            ...
	            <form method="post" action="ConnexionVendeur.ma" class="search-location mt-md-5">
		        		...
		        		<div class="row justify-content-center">
		        			<div class="col-lg-10 align-items-end">
				                ...
				                <input type="mail" class="form-control" placeholder="votre email" name="email">
		        		...
		        		<br>
              			<div class="row justify-content-center">
		        			<div class="col-lg-10 align-items-end">
		        				<div class="form-group">
		          				<div class="form-field">
				                <input type="submit" class="form-control btn btn-primary" name="ConnexionVendeur" value='Se connecter'>
