...
<link rel="stylesheet" href="css/accueil_css/jquery.timepicker.css">
  ...
  <div class="card-body">
    <h4 class="card-title">Special title treatment</h4>
     <form class="form" method="" action="" style="width: 70%; margin: 0 auto; ">
                        <p class="description text-center">veuillez renseigner une date valide </p>
      ...
      <option>5</option>
                    ...
                    <br><br>
   <center> <a href="#0" class="btn btn-success">Valider Réservation</a></center>
  </div>
</div>
<br><br><br>
