	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active"><a href="FormConnexionVendeur.ma"
								...
								<div class="col-lg-10 align-items-end">
									<div class="form-group">
										<div class="form-field">
											<label><strong>Email</strong></label> <input type="mail"
												class="form-control" placeholder="votre email" name="email">
										</div>
									</div>
								</div>
								<div class="col-lg-10 align-items-end">
									<div class="form-group">
										...
										<div class="form-field">
											<label><strong>Mot de Passe</strong></label> <input
									...
									<div class="form-group">
										<div class="form-field">
											<input type="submit" class="form-control btn btn-primary"
												name="ConnexionVendeur" value='Se connecter'>
