...
public class Vendeur {
	...
	public Vendeur(String nom, String prenom, String date_naissane, String num_cin, String sexe, String email,
			String mot_de_passe, String adresse, String pays, String ville, String num_telephone) {
		super();
		this.nom = nom;
		this.prenom = prenom;
	...
	public Vendeur(int id, String nom, String prenom, String date_naissane, String num_cin, String sexe, String email,
			String mot_de_passe, String adresse, String pays, String ville, String num_telephone) {
		super();
		this.id = id;
		this.nom = nom;
